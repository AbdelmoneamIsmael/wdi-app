...
class Initial implements CouponsState {
  const Initial();
...
class Loading implements CouponsState {
  const Loading();
...
class Loaded implements CouponsState {
  const Loaded();
...
class Error implements CouponsState {
...
@override
String toString() {
  return 'CouponsState.error(message: $message)';
}
...
/// @nodoc
abstract mixin class $ErrorCopyWith<$Res> implements $CouponsStateCopyWith<$Res> {
