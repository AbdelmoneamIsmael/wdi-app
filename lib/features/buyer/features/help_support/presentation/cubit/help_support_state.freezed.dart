...
part of 'help_support_state.dart';
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is HelpSupportState);
}
...
/// @nodoc
class $HelpSupportStateCopyWith<$Res>  {
$HelpSupportStateCopyWith(HelpSupportState _, $Res Function(HelpSupportState) __);
}


/// Adds pattern-matching-related methods to [HelpSupportState].
extension HelpSupportStatePatterns on HelpSupportState {
...
return loaded();case Error() when error != null:
...
class Initial implements HelpSupportState {
  const Initial();
...
@override
String toString() {
  return 'HelpSupportState.initial()';
}
...
class Loading implements HelpSupportState {
  const Loading();
...
@override
String toString() {
  return 'HelpSupportState.loading()';
}
...
class Loaded implements HelpSupportState {
  const Loaded();
...
@override
String toString() {
  return 'HelpSupportState.loaded()';
}
...
class Error implements HelpSupportState {
  const Error(this.message);
  

 final  String message;

/// Create a copy of HelpSupportState
...
@override
String toString() {
  return 'HelpSupportState.error(message: $message)';
}
...
/// @nodoc
abstract mixin class $ErrorCopyWith<$Res> implements $HelpSupportStateCopyWith<$Res> {
