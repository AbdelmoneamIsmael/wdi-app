...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( Initial value)?  initial,TResult Function( ChangeIndex value)?  changeIndex,required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( Initial value)  initial,required TResult Function( ChangeIndex value)  changeIndex,}){
final _that = this;
switch (_that) {
case Initial():
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( Initial value)?  initial,TResult? Function( ChangeIndex value)?  changeIndex,}){
final _that = this;
switch (_that) {
case Initial() when initial != null:
return initial(_that);case ChangeIndex() when changeIndex != null:
...
class ChangeIndex implements MainState {
...
@override
String toString() {
  return 'MainState.changeIndex(index: $index)';
}
...
/// @nodoc
abstract mixin class $ChangeIndexCopyWith<$Res> implements $MainStateCopyWith<$Res> {
