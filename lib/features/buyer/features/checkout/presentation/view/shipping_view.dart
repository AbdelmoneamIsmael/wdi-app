        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(),
              ShippingMetionItemWidget(
                isSelected: true,
                title: 'Standard Shipping',
                description: '5-7 business days',
                time: 'Regular delivery with tracking',
                icon: Assets.icons.shippingStander,
              ),
              ShippingMetionItemWidget(
                isSelected: false,
                title: 'Express Shipping',
                description: '2-3 business days',
                time: 'Faster delivery with priority handling',
                icon: Assets.icons.shippingCar,
              ),
              ShippingMetionItemWidget(
                isSelected: false,
                title: 'Standard Shipping',
                description: '5-7 business days',
                time: 'Fastest option available',
                icon: Assets.icons.shippingFlash,
              ),
            ],
          ),
        ),
        ...
        BlocBuilder<CheckoutCubit, CheckoutState>(
          builder: (context, state) {
            return ElevatedButton(
              onPressed: () {
                context.read<CheckoutCubit>().setCurrentStep(3);
              },
