...
class Initial implements AccountState {
  const Initial();
...
class Loading implements AccountState {
  const Loading();
...
class Loaded implements AccountState {
  const Loaded();
...
class Error implements AccountState {
...
/// @nodoc
abstract mixin class $ErrorCopyWith<$Res> implements $AccountStateCopyWith<$Res> {
