...
class Initial implements WishlistState {
  const Initial();
...
class Loading implements WishlistState {
  const Loading();
...
class Loaded implements WishlistState {
  const Loaded();
...
class Error implements WishlistState {
...
/// @nodoc
abstract mixin class $ErrorCopyWith<$Res> implements $WishlistStateCopyWith<$Res> {
