...
part of 'loyalty_program_state.dart';
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is LoyaltyProgramState);
}
...
/// @nodoc
class $LoyaltyProgramStateCopyWith<$Res>  {
$LoyaltyProgramStateCopyWith(LoyaltyProgramState _, $Res Function(LoyaltyProgramState) __);
}


/// Adds pattern-matching-related methods to [LoyaltyProgramState].
extension LoyaltyProgramStatePatterns on LoyaltyProgramState {
...
class Initial implements LoyaltyProgramState {
  const Initial();
...
@override
String toString() {
  return 'LoyaltyProgramState.initial()';
}
...
class Loading implements LoyaltyProgramState {
  const Loading();
...
@override
String toString() {
  return 'LoyaltyProgramState.loading()';
}
...
class Loaded implements LoyaltyProgramState {
  const Loaded();
...
@override
String toString() {
  return 'LoyaltyProgramState.loaded()';
}
...
class Error implements LoyaltyProgramState {
...
@override
String toString() {
  return 'LoyaltyProgramState.error(message: $message)';
}
...
/// @nodoc
abstract mixin class $ErrorCopyWith<$Res> implements $LoyaltyProgramStateCopyWith<$Res> {
