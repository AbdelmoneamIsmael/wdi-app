...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is PaymentMethodsState);
}
...
/// @nodoc
class $PaymentMethodsStateCopyWith<$Res>  {
$PaymentMethodsStateCopyWith(PaymentMethodsState _, $Res Function(PaymentMethodsState) __);
}
...
class Initial implements PaymentMethodsState {
  const Initial();
...
class Loading implements PaymentMethodsState {
  const Loading();
...
class Loaded implements PaymentMethodsState {
  const Loaded();
...
@override
String toString() {
  return 'PaymentMethodsState.loaded()';
}
...
class Error implements PaymentMethodsState {
...
/// @nodoc
abstract mixin class $ErrorCopyWith<$Res> implements $PaymentMethodsStateCopyWith<$Res> {
